...
public protocol BidirectionLoadingTableViewDelegate: AnyObject {
  func hasMoreData() -> Bool
}

public final class BidirectionLoadingTableView: UITableView {

  public weak var loadingDelegate: BidirectionLoadingTableViewDelegate?

  public var pullToRefreshAction: (() -> Void)? {
    didSet {
  ...
  public var bottomLoadingAction: (() -> Void)? {
    didSet {
  ...
  public var isTopRefreshing: Bool = false {
    didSet {
  ...
  public var isBottomLoading: Bool = false {
    didSet {
